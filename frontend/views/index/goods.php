...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="">首页</a> > <a href="">电脑、办公</a> > <a href=""><?=$good->brand->name?></a> ><?=$good->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
        ...
        <div class="related_cat leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    ...
                    <li><?=\yii\helpers\Html::a($brother->name,\yii\helpers\Url::to(['index/goods','id'=>$brother->id]))?></li>
                    <?php endforeach;?>
                </ul>
            </div>
        </div>
...
<!--                        <img src="images/preview_m1.jpg" alt="" />               <!-- 第一幅图片的中图 -->-->
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['member/add-goods'])?>" method="post" class="choose">
                    <ul>
