    ...
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                <?php foreach ($borthers as $borther):?>
                <div class="child">
                    <h3 class="on"><b></b><?=$borther->name?></h3>
                    <ul>
                        <?php foreach ($borther->children as $child):?>
                        <li><?=\yii\helpers\Html::a($child->name,\yii\helpers\Url::to(['index/list','id'=>$child->id]))?></li>
                        <?php endforeach;?>
                    </ul>
                </div>
                <?php endforeach;?>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><?=\yii\helpers\Html::img($good->logo)?></dt>
                        <dd><?=\yii\helpers\Html::a($good->name,\yii\helpers\Url::to(['index/goods','id'=>$good->id]))?></dt>
