...
<div class="header w1210 bc mt15">
                ...
                <dd>
                    <div class="prompt">
                        <?php if(Yii::$app->user->isGuest){
                            ...
                            echo '您好:<span style="color: red">'.Yii::$app->user->identity->username.'</span>';
                        }?>
                    </div>
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><?=Html::a('找回密码',\yii\helpers\Url::to(['member/find-pwd']))?></li>
                            <li><a href="">我的订单></a></li>
                            <li><?=Html::a('收货地址',\yii\helpers\Url::to(['address/address']))?></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                <?php $models=\backend\models\GoodsCategory::find()->where(['parent_id'=>0])->all();

                foreach ($models as $model){

                    echo "<div class='cat item1'>";
                    echo "<h3>".Html::a($model->name,['index/list','id'=>$model->id])."<b></b></h3>";

                    echo "<div class='cat_detail'>";
                    foreach ($model->children as $chlid){

                        echo "<dl class='dl_1st'>";
                        echo "<dt>".Html::a($chlid->name,['index/list','id'=>$chlid->id])."</dt>";
                        foreach($chlid->children as $sun){
                            echo "<dd>".Html::a($sun->name,['index/list','id'=>$sun->id])."</dd>";
                        }
                        echo "</dl>";
                    }
                    echo "</div>";
